...
--------------------------------------------------------------------------------
Simple Recall                  183        70.5%        70.5%           +0.0%        ➖ NEUTRAL
Two-Hop Reasoning              200        32.5%        32.5%           +0.0%        ➖ NEUTRAL
Three-Hop Reasoning            105        42.9%        42.9%           +0.0%        ➖ NEUTRAL
Long Context (5-7 facts)       200        52.0%        52.0%           +0.0%        ➖ NEUTRAL
Combined Reasoning + Memory    200        36.0%        36.0%           +0.0%        ➖ NEUTRAL
Stress Test (10+ facts)        130        53.1%        53.1%           +0.0%        ➖ NEUTRAL

📊 SUMMARY STATISTICS
================================================================================
Category                        Baseline     With Steering   Improvement
--------------------------------------------------------------------------------
Simple Recall                   70.5%         70.5%           +0.0%
Moderate (2-3 hops)             37.7%         37.7%           +0.0%
Hard (long context)             44.0%         44.0%           +0.0%
Extreme (10+ facts)             53.1%         53.1%           +0.0%
--------------------------------------------------------------------------------
OVERALL AVERAGE                 47.5%         47.5%           +0.0%
   - Progressive levels: 1018 test cases across 6 levels
...
🎯 Steering Results:
   - Bottleneck steering: +0.0%
   - Steering (identified): +0.0%
   - Steering (Cluster 9): +0.0%
💾 Results saved to: experiment_logs/universal_steering_analysis.json


results - read dataset - new
================================================================================
PERFORMANCE COMPARISON: BASELINE vs STEERING (Dataset Prompts)
================================================================================
Level                          Tasks    Baseline     With Steering   Change       Status
--------------------------------------------------------------------------------
Simple Recall                  100        91.0%        91.0%           +0.0%        ➖ NEUTRAL
Two-Hop Reasoning              100        53.0%        49.0%           -4.0%        ❌ NEGATIVE
Three-Hop Reasoning            100        44.0%        44.0%           +0.0%        ➖ NEUTRAL
Long Context (5-7 facts)       100        79.0%        79.0%           +0.0%        ➖ NEUTRAL
Combined Reasoning + Memory    100        42.0%        41.0%           -1.0%        ❌ NEGATIVE
Stress Test (10+ facts)        100        61.0%        61.0%           +0.0%        ➖ NEUTRAL
--------------------------------------------------------------------------------
OVERALL AVERAGE                  600        61.7%        60.8%           -0.8%
   - Progressive levels: 600 test cases across 6 levels
...
🎯 Steering Results:
   ...
   - Steering (identified): +0.0%
   - Steering (Cluster 9): +0.0%
   - Progressive levels: -0.8% overall (steering showed slight negative impact)
💾 Results saved to: experiment_logs/universal_steering_analysis.json
