"""
Universal Interpretability and Steering for Dense Mamba
==========================================================

Github repository: https://github.com/WailordHe/DenseSSM


This script performs:
1. Interpretability analysis on Dense Mamba models
2. Identifies critical layers and cluster neurons
3. Tests universal steering across Dense Mamba variants
